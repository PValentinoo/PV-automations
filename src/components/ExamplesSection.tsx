...
const ExamplesSection = () => {
  const examples = [
    ...
    },
    {
      ...
      description: "SMakroer og automatiseringer, der neutraliserer gentagne opgaver, fra datahåndtering og beregninger til oprettelse af sheets og funktioner, hvilket effektiviserer arbejdet og reducerer fejl.",
